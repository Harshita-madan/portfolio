...
const Skills = () => {
  const skillCategories = [
    ...
    },
    {
      ...
      icon: Code,
      skills: ["End-to-end web applications", "RESTful APIs", "Database Design"],
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {skillCategories.map((category, index) => (
            ...
            >
              ...
              {/* Hover glow effect */}
              <div className={`absolute inset-0 rounded-xl bg-gradient-to-br ${category.color} opacity-0 group-hover:opacity-10 transition-opacity duration-300 pointer-events-none`} />
            </motion.div>
          ))}
        </div>
      </div>
